...
- Modify world-owned docs, tests, state, and internal implementation.
- Extend public interfaces only with backwards-compatible additions.

## Forbidden responsibilities
- Do not own behavior assigned to: weather.
...
## Common mistakes
- Editing unrelated capsules to complete world work.
